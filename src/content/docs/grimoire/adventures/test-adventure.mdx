...
description: A simple test adventure for Pages CMS
sidebar:
  label: Test
  order: 1
---
...
This is a simple test adventure to ensure that the Pages CMS can properly find and edit content files.
