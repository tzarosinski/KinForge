...
<CardGrid>
  ...
  <Card title="🛡️ Siege of Ironhold" icon="shield">
    **60 min • Advanced**

    Defend the citadel against the Shadow Legion. Three phases of escalating war: The Walls, The Gate, and The Last Stand.

    <div class="adventure-card-actions">
      <a href="/adventure/siege-of-ironhold" class="play-button">
        <span class="play-icon">▶️</span>
        <span>Play Interactive Adventure</span>
        <span class="arrow">→</span>
      </a>

      <a href="/compendium/adventures/siege-of-ironhold-guide/" class="guide-link">
        📖 Read the Guide First
      </a>
    </div>
  </Card>
